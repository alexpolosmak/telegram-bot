...
return [
    ...
    "to"=>" до ",
    "company_not_working_today"=>"\nУпс, компания не работает сегодня.\nЕсли вы хотите сделать предзаказ просто введите время доставки в формате 00:00 00.00.\nЕсли будете делать заказ сегодня то день/месяц вводить не нужно.",
    ...
    "exist_one_example_company_adress"=>"У этой компании есть только одна точка выдачи. Заказ вы сможете забрать здесь: ",
     "next_day_schedule_"=>"Завтра компания работает с ",
    "days_where_company_not_works"=>"Компания не работает в такие дни: ",
    "monday"=>"Понедельник ",
    "tuesday"=>"Вторник ",
    "wednesday"=>"Среда ",
    "thursday"=>"Четверг ",
